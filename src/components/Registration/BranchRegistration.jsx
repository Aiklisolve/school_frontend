  ...
  return (
    <div className="bg-white rounded-lg shadow-md border border-gray-200 overflow-hidden">
      <div className="bg-indigo-600 px-6 py-4 border-b border-indigo-700">
        <h4 className="text-lg font-semibold text-white">Branch Registration</h4>
        <p className="text-sm text-indigo-100 mt-1">Fill in the details to register a new branch for an existing school</p>
      </div>
      <div className="p-6">
