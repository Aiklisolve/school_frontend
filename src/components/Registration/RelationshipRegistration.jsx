  ...
  return (
    <div className="bg-white rounded-lg shadow-md border border-slate-200 overflow-hidden">
      <div className="bg-gradient-to-r from-slate-700 to-slate-900 px-4 py-2">
        <h4 className="text-base font-bold text-white">Relationship Registration</h4>
        <p className="text-xs text-slate-200 mt-0.5">Create a relationship between a parent and a student</p>
      </div>
      <div className="p-4">
